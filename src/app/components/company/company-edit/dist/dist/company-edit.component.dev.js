...
function () {
  ...
  CompanyEditComponent.prototype.onSubmit = function () {
    ...
    this.http.put(api_1.ApiConstants.apiURL + "/" + api_1.ApiConstants.apiVersion + "/" + api_1.ApiConstants.companyProfile + "/" + id, this.form.value).subscribe(function (res) {
      ...
      if (res.success == true && res.statusCode == 200) {
        ...
        _this.toastr.error(message_1.MessageConstants.serverError, 'Error', {
          timeOut: 6000
        });
  ...
  CompanyEditComponent = __decorate([core_1.Component({
